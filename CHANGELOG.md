...
- The shipped SVG busy block is a named placeholder exemption on the legacy grid (`F-art-geometry-migration`); `F-deepen-rungs-unbuilt` records what is unbuilt.
