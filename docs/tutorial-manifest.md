...
| TUT-OBJECT-NAME-FUNCTION | Street object name to function | Widen sittings 1–2 (Cross the Street, Lights) on the busy block | FEAT-LEARN | taught | child, adult | `content/sittings/widen-1-get-across.json`, `content/sittings/widen-2-lights.json`, `src/app/WidenSitting1.tsx` | `e2e/specs/widen-1-get-across.spec.ts`, `e2e/specs/widen-2-lights.spec.ts` |
