...
export const FILE_ROWS = [
  ...
  { id: 'OWN-SPEC', path: 'SPEC.md', kind: 'OWNER', notes: 'Game behaviour and runtime freeze' },
  ...
  { id: 'OWN-VITE-CONFIG', path: 'vite.config.ts', kind: 'SOURCE', notes: 'Vite + vitest; allowOnly false' },
  ...
  { id: 'OWN-INSPIRATION', path: 'docs/inspiration.md', kind: 'OWNER', notes: 'Do-not-copy sources' },
  { id: 'OWN-ART-BIBLE', path: 'docs/art-bible.md', kind: 'OWNER', notes: 'Look, pixel construction, palette, animation, asset pipeline, originality' },
  ...
  { id: 'OWN-GLOB-ART', glob: 'content/art/**', kind: 'DATA', notes: 'Art tokens (authoritative values; rules in docs/art-bible.md) and provenance records' },
  ...
  { id: 'OWN-GATE-INTEGRITY', path: 'tools/check-gate-integrity.mjs', kind: 'GATE', notes: 'G-unit paper-over scan (GIP-C5); not a 12th named gate' },
  { id: 'OWN-GLOB-TOOLS', glob: 'tools/**', kind: 'GATE', notes: 'Maps, floors, and other gate tools' },
